<template>
  <section class="home">
    <header class="home__header">
      <div class="home-header__logo">
        ...
        >
          <g
            id="Group_364"
            data-name="Group 364"
            transform="translate(-20.066 -27.25)"
          >
            <rect
              id="Rectangle_803"
              ...
              height="70"
              rx="26"
              transform="translate(20.066 29.25)"
              fill="#ffe65a"
            />
            <rect
              id="Rectangle_587"
              ...
              height="64"
              rx="30"
              transform="translate(28.066 33.25)"
              fill="none"
            />
            <g
              id="Rectangle_579"
              data-name="Rectangle 579"
              transform="translate(23.066 27.25)"
              fill="none"
              stroke="#313131"
              stroke-width="2"
            >
            ...
            <rect
              ...
              width="2"
              height="6"
              transform="translate(92.066 66.25)"
              fill="#f5f5f5"
            />
            <rect
              id="Rectangle_720"
              ...
              width="3"
              height="6"
              transform="translate(90.066 66.25)"
              fill="#f5f5f5"
            />
            <rect
              id="Rectangle_721"
              ...
              height="2"
              rx="1"
              transform="translate(91.066 65.25)"
              fill="#313131"
            />
            <rect
              id="Rectangle_722"
              ...
              height="2"
              rx="1"
              transform="translate(90.717 71.25)"
              fill="#313131"
            />
          </g>
        </svg>
        ...
        >
          <path
            d="M24.2 9.03h2.4c13.3 0 24.2 10.8 24.2 24.2v8.1c0 1.7-1.4 3.2-3.2 3.2H3.2c-1.8 0-3.2-1.5-3.2-3.2v-8.1c0-13.4 10.8-24.2 24.2-24.2z"
            fill="#ff4848"
          />
          <path
            d="M47.5 44.53H3.2c-1.8 0-3.2-1.5-3.2-3.2v-8.1c0-13.3 10.8-24.2 24.2-24.2h2.4c13.3 0 24.2 10.8 24.2 24.2v8.1c-.1 1.7-1.5 3.2-3.3 3.2zm-23.3-34.4c-12.8 0-23.1 10.3-23.1 23.1v8.1c0 1.2.9 2.1 2.1 2.1h44.4c1.2 0 2.1-.9 2.1-2.1v-8.1c0-12.7-10.4-23.1-23.1-23.1h-2.4z"
            fill="#313131"
          />
          <path
            d="M28.9 60.53H22.1c-2.1 0-4.1-.4-5.9-1.2-.9-.4-1.8-.9-2.6-1.4-.8-.5-1.6-1.2-2.3-1.9s-1.3-1.4-1.9-2.3c-.5-.8-1-1.7-1.4-2.6-.8-1.9-1.2-3.9-1.2-5.9v-15h37.3v15c0 2.1-.4 4.1-1.2 5.9-.4.9-.9 1.8-1.4 2.6s-1.2 1.6-1.9 2.3c-.7.7-1.4 1.3-2.3 1.9-.8.5-1.7 1-2.6 1.4-1.8.8-3.8 1.2-5.8 1.2z"
            fill="#ffe7c1"
          />
          <path
            d="M7.4 30.83v14.4c0 2 .4 3.9 1.2 5.7.4.9.8 1.7 1.4 2.5.5.8 1.1 1.5 1.8 2.2s1.4 1.3 2.2 1.8 1.6 1 2.5 1.4c1.8.8 3.7 1.2 5.7 1.2H29c2 0 3.9-.4 5.7-1.2.9-.4 1.7-.8 2.5-1.4.8-.5 1.5-1.1 2.2-1.8s1.3-1.4 1.8-2.2 1-1.6 1.4-2.5c.8-1.8 1.2-3.7 1.2-5.7v-14.4H7.4m-1.1-1h38.3v15.5c0 8.7-7.1 15.8-15.8 15.8h-6.7c-8.7 0-15.8-7.1-15.8-15.8v-15.5z"
            fill="#313131"
          />
          <path
            d="M27.6 58.73c-.8 0-1.6-.4-2.1-1.1-.3.5-1 1.1-2.4 1.1-2.1 0-2.8-1.3-2.8-2 0-.2.1-.4.3-.4.2 0 .4.1.4.3 0 .1.2 1.3 2.1 1.3 1.8 0 2-1.2 2-1.3 0-.2.2-.3.4-.4s.4.1.4.3c.2.8 1 1.4 1.8 1.4.9 0 1.7-.6 2-1.4.1-.2.3-.3.5-.2s.3.3.2.5c-.4 1.2-1.5 1.9-2.7 1.9h-.1zM24.7 46.83h1.1c.7 0 1.3.6 1.3 1.3v1.6c0 .7-.6 1.3-1.3 1.3h-1.1c-.7 0-1.3-.6-1.3-1.3v-1.6c0-.7.6-1.3 1.3-1.3zM25.3 55.73c-.2 0-.4-.2-.4-.4v-3.4c0-.2.2-.4.4-.4s.4.2.4.4v3.4c0 .3-.1.4-.4.4zM12.3 41.03h2.6c.4 0 .8.4.8.8s-.4.8-.8.8h-2.6c-.4 0-.8-.4-.8-.8.1-.4.4-.8.8-.8zM36.2 41.03h2.6c.4 0 .8.4.8.8s-.4.8-.8.8h-2.6c-.4 0-.8-.4-.8-.8s.4-.8.8-.8z"
            fill="#313131"
          />
          <path
            d="M33.7 59.13c1.5-1.6 4.1-4.6 4.6-5.4.8-1.2 1.3-2.5 1.7-3.9.4-1.4.6-2.8.6-4.3v-15.8h2.9v15.3c.1 6.4-3.8 12-9.8 14.1z"
            fill="#ffce80"
          />
          <path
            d="M31.814 37.93h-12.7c-1.5 0-3-.3-4.4-.8s-2.7-1.2-3.8-2.1-2.1-2-2.9-3.2c-.8-1.2-1.4-2.6-1.8-4l-.2-.9.9.2c4.7 1.2 11.7 2.6 18.8 2.6 7 0 14-1.4 18.6-2.5l.9-.2-.2.9c-.4 1.4-1 2.7-1.8 4-.8 1.2-1.8 2.3-2.9 3.1-1.2.9-2.4 1.6-3.8 2.1-1.7.5-3.2.8-4.7.8z"
            fill="#ff4848"
          />
          <path
            d="M31.814 37.43c1.5 0 2.9-.2 4.3-.7 1.3-.5 2.6-1.1 3.7-2 1.1-.9 2-1.9 2.8-3 .8-1.2 1.4-2.5 1.7-3.8-4.7 1.2-11.7 2.5-18.8 2.5s-14.2-1.4-18.9-2.6c.4 1.4.9 2.7 1.7 3.8.8 1.2 1.7 2.2 2.8 3 1.1.9 2.3 1.5 3.7 2s2.8.7 4.3.7l12.7.1m0 1h-12.7c-1.6 0-3.1-.3-4.6-.8-1.4-.5-2.8-1.2-4-2.2-1.2-.9-2.2-2-3.1-3.3-.9-1.3-1.5-2.7-1.9-4.1-.1-.4 0-.7.3-1 .2-.2.5-.3.7-.3h.3c4.6 1.2 11.7 2.5 18.7 2.5 6.9 0 13.9-1.4 18.5-2.5h.3c.3 0 .6.1.8.3.3.3.4.6.3 1-.4 1.5-1 2.9-1.9 4.1-.8 1.2-1.9 2.3-3.1 3.3-1.2.9-2.5 1.7-4 2.2-1.5.6-3 .8-4.6.8z"
            fill="#313131"
          />
          <path
            d="M32.4 37.33c.5-.1 1-.2 1.5-.4 1.3-.4 2.5-1 3.7-1.8 1.1-.8 2-1.7 2.7-2.9.7-1.1 1.3-2.4 1.5-3.8.2-.3.9-.4 1.5-.5.3 0 .6-.1.8-.1h.1c-.4 1.3-1 2.6-1.8 3.8-.8 1.1-1.7 2.2-2.8 3-1.1.8-2.3 1.5-3.6 2-1.1.5-2.3.7-3.6.7z"
            fill="#cc0909"
          />
          <circle
            cx="18934.4"
            ...
            r="1.4"
            fill="#fff"
            transform="translate(-18924 -14515.57)"
          />
          <path
            d="M46.2 22.93H48c.3 0 .5.2.5.5s-.2.5-.5.5h-1.8c-.3 0-.5-.2-.5-.5 0-.2.2-.5.5-.5zM42 29.23h1.6c.3 0 .5.2.5.5s-.2.5-.5.5H42c-.3 0-.5-.2-.5-.5 0-.2.2-.5.5-.5zM44.6 37.93h5.5c.3 0 .5.2.5.5s-.2.5-.5.5h-5.5c-.3 0-.5-.2-.5-.5s.2-.5.5-.5zM44.1 33.23h6c.3 0 .5.2.5.5s-.2.5-.5.5h-6c-.3 0-.5-.2-.5-.5s.2-.5.5-.5zM.5 37.93h6c.3 0 .5.2.5.5s-.2.5-.5.5h-6c-.3 0-.5-.2-.5-.5s.2-.5.5-.5zM.5 33.23h6c.3 0 .5.2.5.5s-.2.5-.5.5h-6c-.3 0-.5-.2-.5-.5s.2-.5.5-.5zM43.3 22.93h.5c.3 0 .5.2.5.5s-.2.5-.5.5h-.5c-.3 0-.5-.2-.5-.5 0-.2.2-.5.5-.5zM40.2 29.23h.5c.3 0 .5.2.5.5s-.2.5-.5.5h-.5c-.3 0-.5-.2-.5-.5-.1-.2.2-.5.5-.5z"
            fill="#313131"
          />
          <path
            d="M4.3 24.83c.4 0 .7.3.7.7v5c0 .4-.3.7-.7.7-.4 0-.7-.3-.7-.7v-5c.1-.4.4-.7.7-.7z"
            fill="#ffacac"
          />
          <path
            d="M25.48 24.5c-2.6 0-5.1-.5-7.5-1.5-1.1-.5-2.2-1.1-3.3-1.8-1-.7-2-1.5-2.8-2.3-.9-.9-1.7-1.8-2.3-2.8-.7-1-1.3-2.1-1.8-3.3-1-2.4-1.5-4.9-1.5-7.5V5c0-1.4.1-2.7.4-4.1h1c.4 2 1.2 3.9 2.3 5.7 1.1 1.7 2.4 3.2 4 4.5s3.4 2.3 5.3 3c2 .7 4.1 1.1 6.2 1.1s4.2-.4 6.2-1.1c1.9-.7 3.7-1.7 5.3-3s2.9-2.8 4-4.5c1-1.7 1.8-3.6 2.2-5.7h1c.3 1.3.4 2.7.4 4.1v.4c0 2.6-.5 5.1-1.5 7.5-.5 1.1-1.1 2.2-1.8 3.3-.7 1-1.5 2-2.3 2.8-.9.9-1.8 1.7-2.8 2.3-1 .7-2.1 1.3-3.3 1.8-2.3.9-4.8 1.4-7.4 1.4z"
            fill="#ffe65a"
          />
          <path
            d="M25.48 24c2.5 0 5-.5 7.3-1.5 1.1-.5 2.2-1 3.2-1.7s1.9-1.4 2.8-2.3c.8-.8 1.6-1.8 2.3-2.8s1.3-2.1 1.7-3.2c1-2.3 1.5-4.7 1.5-7.3V5c0-1.3-.1-2.7-.4-3.9-.4 2.1-1.2 4-2.4 5.8-1.1 1.8-2.5 3.3-4.1 4.7-1.6 1.3-3.5 2.4-5.4 3.1-2 .7-4.2 1.1-6.4 1.1s-4.3-.4-6.4-1.1c-2-.7-3.8-1.8-5.4-3.1s-3-2.9-4.1-4.7-1.9-3.8-2.4-5.8c-.3 1.2-.5 2.6-.5 3.9v.4c0 2.5.5 5 1.5 7.3.5 1.1 1 2.2 1.7 3.2s1.4 1.9 2.3 2.8c.8.8 1.8 1.6 2.8 2.3s2.1 1.3 3.2 1.7c2.2.8 4.7 1.3 7.2 1.3m0 1c-2.7 0-5.2-.5-7.7-1.5-1.2-.5-2.3-1.1-3.3-1.8s-2-1.5-2.9-2.4-1.7-1.9-2.4-2.9c-.7-1.1-1.3-2.2-1.8-3.3-1-2.4-1.5-5-1.5-7.7V5c0-1.4.1-2.8.4-4.2.1-.5.5-.8 1-.8s.9.3 1 .8c.4 2 1.2 3.8 2.2 5.5s2.3 3.2 3.9 4.4c1.5 1.3 3.2 2.3 5.1 3s3.9 1.1 6 1.1 4.1-.4 6-1.1c1.9-.7 3.6-1.7 5.1-3 1.5-1.2 2.8-2.7 3.9-4.4s1.8-3.6 2.2-5.5c.1-.5.5-.8 1-.8s.9.3 1 .8c.3 1.4.5 2.8.5 4.2v.4c0 2.7-.5 5.2-1.5 7.7-.5 1.2-1.1 2.3-1.8 3.3s-1.5 2-2.4 2.9c-.9.9-1.9 1.7-2.9 2.4-1.1.7-2.2 1.3-3.3 1.8-2.6 1-5.2 1.5-7.8 1.5z"
            fill="#313131"
          />
          <path
            d="M36.4 20.43c2-3 3-6.6 3-10.2v-.4-.4c.7-.8 1.3-1.7 1.9-2.6 1.1-1.8 1.9-3.8 2.4-5.8.3 1.3.4 2.6.4 3.9v.4c0 2.5-.5 5-1.5 7.3-.5 1.1-1 2.2-1.7 3.2s-1.4 1.9-2.3 2.8c-.6.6-1.4 1.2-2.2 1.8z"
            fill="#ffc238"
          />
          <path
            d="M7.2 1.03c.4 2.1 1.2 4 2.4 5.8.1.2.3.5.5.7-.5 1.8-.8 3.7-.8 5.6v1.4c-.4-.6-.7-1.3-1-2-1-2.3-1.5-4.8-1.5-7.3v-.4c-.1-1.2.1-2.5.4-3.8z"
            fill="#fff9d9"
          />
          <path
            d="M7.1 45.63c.7 0 1.9 1.2 1.9 2s-.2.4-1 .4c-.7 0-.6-.2-1.4.2-.1-.8-.2-1.7-.3-2.5.1-.4.4-.1.8-.1z"
            fill="#ffe7c1"
          />
          <g transform="translate(-18924 -14515.57)">
            <circle
              cx="18931.1"
              cy="14563.7"
              r=".5"
          ...
          <g>
            <path
              fill="#ffe7c1"
              d="M29.9 37.93H32v2.1h-2.1z"
            />
          </g>
          <g>
            <path
              fill="#ff4848"
              d="M29.9 35.83H32v2.1h-2.1z"
            />
          </g>
          <g transform="translate(-18924 -14515.57)">
            <circle
      ...
      <button
        class="home-header__install-button"
        aria-label="安裝至手機桌面"
      >
